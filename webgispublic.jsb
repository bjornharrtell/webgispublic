...
<project path="" name="WebGIS Public" author="SWECO Position AB" version="1.1.0" copyright="$projectName $version&#xD;&#xA;Copyright(c) 2007-2008, $author.&#xD;&#xA;&#xD;&#xA;Licensed under GPLv3&#xD;&#xA;http://www.gnu.org/licenses/gpl.html" output="$project\build" source="False" source-dir="$output\source" minify="False" min-dir="$output\build" doc="False" doc-dir="$output\docs" master="true" master-file="$output\yui-ext.js" zip="true" zip-file="$output\yuo-ext.$version.zip">
